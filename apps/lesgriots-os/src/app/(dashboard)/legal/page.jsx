 ...
 *
 * Deux sections : les templates The Futur Legal Kit (anglais, droit US), et
 * l'avertissement qui va avec.
 *
 * Il y en avait une troisième, les générateurs FR pré-remplis (NDA, cession
 * de droit à l'image, MSA). Leurs boutons vivaient sur la fiche client et la
 * fiche projet du Studio, parties dans apps/studio-os : la section décrivait
 * donc des gestes devenus impossibles. Les routes /api/clients/[id]/nda et
 * /msa existent toujours ; le jour où on veut ces deux documents depuis une
 * fiche entreprise, il suffit d'y remonter ClientLegalActions.
 */
