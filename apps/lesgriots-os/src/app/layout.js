      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var p=location.pathname,h=location.hostname.toLowerCase(),g=h==='app.lagriotheque.com'||['/formations','/pipeline-formations','/sessions-list','/apprenants','/organisme','/apercu','/catalogue','/intervenants','/lieux','/qualite','/parametres-formation'].some(function(r){return p===r||p.indexOf(r+'/')===0});if(g||localStorage.getItem('os-theme')==='light')document.documentElement.setAttribute('data-theme','light');document.documentElement.setAttribute('data-monde',g?'griotheque':'studio')}catch(e){}`,
          }}
        />
