...
function EntreprisesView({ clients = [], sessions = [], onRefresh }) {
  const [search, setSearch] = useState('');
  const [selected, setSelected] = useState(null);
...
function QualiteView({ formations, sessions }) {
...
function TableauView({ formations, categories, onRefresh }) {
...
// ═══════════════════════════════════════════════════════════════
function GrioPipelineView({ formations }) {
  const STAGES = [
...
function GrioOverview({ formations, sessions, clients, onNavigateSession }) {
  // Calculate KPIs
